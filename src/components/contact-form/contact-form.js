...
const ContactForm = ({ formspreeEndpoint, budget }) => {
  ...
  return (
    <>
      ...
      <h4 className="font-header font-semibold text-front text-sm">Email: <a className="font-normal" href="mailto:tamara.evanoff@co.rvu.edu">tamara.evanoff@co.rvu.edu</a></h4>
      <h4 className="font-header font-semibold text-front text-sm mb-3">Phone: <a className="font-normal" href="mailto:tamara.evanoff@co.rvu.edu">540.746.2556</a></h4>
